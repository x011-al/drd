...
coordinates = [
    (178, 210),  # Koordinat pertama
    (582, 205),  # Koordinat kedua, tambahkan jika lebih dari satu
    (1008, 266),  # Koordinat pertama
    (197, 476),  # Koordinat kedua, tambahkan jika lebih dari satu
]  
