...
coordinates = [
    (133, 205),  # Koordinat pertama
    (513, 189),  # Koordinat kedua, tambahkan jika lebih dari satu
    (865, 203),  # Koordinat pertama
    (1191, 203),  # Koordinat kedua, tambahkan jika lebih dari satu
]  
