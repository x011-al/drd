...
coordinates = [
    (124, 225),  # Koordinat pertama
    (563, 244),  # Koordinat kedua, tambahkan jika lebih dari satu
    (888, 238),  # Koordinat pertama
    (1285, 229),  # Koordinat kedua, tambahkan jika lebih dari satu
]  
