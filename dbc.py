...
coordinates = [
    (184, 212),  # Koordinat pertama
    (593, 213),  # Koordinat kedua, tambahkan jika lebih dari satu
    (900, 213),  # Koordinat pertama
    (1276, 210),  # Koordinat kedua, tambahkan jika lebih dari satu
]  
